export const environment = {
  ...
  API: {
    ...
    AUTH: 'https://dominus.runasp.net/api/Auth',
    USERS: 'https://dominus.runasp.net/api/Users/Admin',
    REG_URL: 'https://dominus.runasp.net/api/Auth/register',
    LOG_URL: 'https://dominus.runasp.net/api/Auth/login',
    SHIPPING_ADDRESS: 'https://dominus.runasp.net/api/shipping-address',
  }
};
